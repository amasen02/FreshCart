...
/// the same request share one <see cref="SqlConnection"/>. Opening retries transient failures so a
/// contended cold boot (the database container still warming up) does not fault startup; this mirrors
/// the EnableRetryOnFailure resilience the EF-backed services already have.
/// </summary>
